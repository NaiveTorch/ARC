...
/* ARC MOD BEGIN */
// FstreamTest outputs temporary test files to current directory. To output
// them to the STLport specific directory, introduce following constant and
// use it as temporary file instead.
const char kTemporaryFileName[] =
    ARC_TARGET_PATH "/intermediates/stlport_unittest/test_file.txt";
const char kTemporaryFileNameForWin32[] =
    ARC_TARGET_PATH "/intermediates/stlport_unittest/win32_file_format.tmp";
/* ARC MOD END */
...
{
  /* ARC MOD BEGIN */
  // Change the temporary test file path to not output to the current directory.
  // ofstream f( "test_file.txt" );
  ofstream f( kTemporaryFileName );
  /* ARC MOD END */
...
void FstreamTest::io()
{
  ...
  basic_fstream<char,char_traits<char> > f( kTemporaryFileName, ios_base::in | ios_base::out | ios_base::trunc );
  /* ARC MOD END */
...
{
  {
    ...
    ofstream of(kTemporaryFileName, ios_base::out | ios_base::binary | ios_base::trunc);
    /* ARC MOD END */
...

  {
    ...
    ifstream is(kTemporaryFileName, ios_base::in | ios_base::binary);
    /* ARC MOD END */
...
void FstreamTest::tellp()
{
   ...
   */
  {
    ...
    // Change the temporary test file path to not output to the current directory.
    // ofstream o( "test_file.txt", ios_base::app | ios_base::out );
    ofstream o( kTemporaryFileName, ios_base::app | ios_base::out );
    /* ARC MOD END */
  ...
  { // for reference, to test fopen/ftell behaviour in append mode:
    ...
    FILE* f = fopen( kTemporaryFileName, "a" );
    /* ARC MOD END */
...
void FstreamTest::buf()
{
  ...
  fstream ss( kTemporaryFileName, ios_base::in | ios_base::out | ios_base::binary | ios_base::trunc );
  /* ARC MOD END */
...
{
  {
    // Test in binary mode:
    {
      ...
      fstream s( kTemporaryFileName, ios_base::in | ios_base::out | ios_base::binary | ios_base::trunc );
      /* ARC MOD END */
      CPPUNIT_ASSERT( s );
    ...
    fstream s( kTemporaryFileName, ios_base::in | ios_base::out | ios_base::binary );
    /* ARC MOD END */
    CPPUNIT_ASSERT( s );
...

  {
    // Test in text mode:
    {
      ...
      fstream s( kTemporaryFileName, ios_base::in | ios_base::out | ios_base::trunc );
      /* ARC MOD END */
      CPPUNIT_ASSERT( s );
    ...
    fstream s( kTemporaryFileName, ios_base::in | ios_base::out );
    /* ARC MOD END */
    CPPUNIT_ASSERT( s );
    ...
    (!defined (_STLP_NO_WCHAR_T) && defined (_STLP_USE_EXCEPTIONS))
  {
...

    {
      ...
      wfstream s( kTemporaryFileName, ios_base::in | ios_base::out | ios_base::trunc );
      /* ARC MOD END */
      CPPUNIT_ASSERT( s );
      s.imbue(loc);
      CPPUNIT_ASSERT( s );
    ...
    wfstream s( kTemporaryFileName, ios_base::in | ios_base::out );
    /* ARC MOD END */
    CPPUNIT_ASSERT( s );
    s.imbue(loc);
    CPPUNIT_ASSERT( s );
...
{
  {
    ...
    ofstream ofstr(kTemporaryFileName, ios_base::binary);
    /* ARC MOD END */
    if (!ofstr)
...

  {
    ...
    ifstream in(kTemporaryFileName, ios_base::binary);
    /* ARC MOD END */
    CPPUNIT_ASSERT( in );
...
void FstreamTest::win32_file_format()
{
  ...
  const char* file_name = kTemporaryFileNameForWin32;
  /* ARC MOD END */
...
void FstreamTest::custom_facet()
{
  ...
  const char* fileName = kTemporaryFileName;
  /* ARC MOD END */
  //File preparation:
  {
