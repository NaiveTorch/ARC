...
class CppChecker(object):
  ...
  # ARC MOD BEGIN
  # Increase the number from 50 to 150 as our code is slightly less organized
  # than Chromium's so as not to miss bad include lines. For example, the first
  # #include "..." line in common/logger.h is at line 90.
  _MAX_UNINTERESTING_LINES = 150
  # ARC MOD END
