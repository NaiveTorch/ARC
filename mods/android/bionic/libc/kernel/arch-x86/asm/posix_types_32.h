...
#undef __FD_SET
/* ARC MOD BEGIN */
/* The original code has instructions which NaCl's validator does not
 * allow. We use the portable implementation defined in
 * libc/kernel/arch-arm/asm/posix_types.h instead. */
#include <string.h>
