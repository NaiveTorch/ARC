// ARC MOD TRACK "third_party/nacl-glibc/sysdeps/nacl/nacl_syscalls.h"
/*
...
/* ARC MOD BEGIN */
/* nacl_stat.h cannot be included from user code.
 * Add the definition of nacl_abi_off_t instead. */
#include <stdint.h>
