// ARC MOD TRACK "third_party/nacl-glibc/sysdeps/nacl/irt.h"
// ARC MOD IGNORE
...
// ARC MOD BEGIN
// Use NaCl ABI instead of Linux ABI in this header file. We will
// undef them later.
#include <stdint.h>
...
#define timespec nacl_abi_timespec
#define timeval nacl_abi_timeval
// ARC MOD END
...
// ARC MOD BEGIN
// Remove mappings to NaCl ABI types.
#undef off_t
#undef stat
#undef timespec
#undef timeval
