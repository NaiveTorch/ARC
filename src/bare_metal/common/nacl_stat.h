// ARC MOD TRACK "third_party/nacl-glibc/sysdeps/nacl/nacl_stat.h"
// ARC MOD IGNORE
// Everything in this directory is ephemeral and we will add no new
...
// ARC MOD BEGIN
// We need __stat_to_nacl_abi_stat instead of __nacl_abi_stat_to_stat.
/* Converts struct stat to struct nacl_abi_stat. */
void __stat_to_nacl_abi_stat(struct stat *st, struct nacl_abi_stat *nacl_st);
// ARC MOD END
#endif
